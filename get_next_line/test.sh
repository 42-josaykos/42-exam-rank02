...
cd $(dirname $0)
clang -Wall -Werror -Wextra main1.c get_next_line.c -o a.out || (echo COMPILATION FAILED && exit 1)
echo ">>>>>>>>>>> Read main1.c"
...
clang -Wall -Werror -Wextra main2.c get_next_line.c -o a.out
clang -Wall -Werror -Wextra main2_generator.c -o gen.out
./gen.out > ours
